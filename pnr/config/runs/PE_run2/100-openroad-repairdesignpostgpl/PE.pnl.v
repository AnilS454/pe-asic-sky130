module PE (clear_acc,
 ...
 sky130_fd_sc_hd__and4_1 _0845_ (.A(net47),
    ...
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__nand2_1 _0846_ (.A(net72),
    .B(_0204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _0856_ (.A1(net75),
    ...
    .VPWR(VPWR),
    .X(_0211_));
 sky130_fd_sc_hd__nand4_1 _0857_ (.A(net75),
    .B(net52),
    .C(_0196_),
    .D(net74),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o22a_1 _0897_ (.A1(\product_reg[0] ),
    ...
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__nand4_1 _0898_ (.A(net90),
    .B(net133),
    .C(net111),
    .D(net135),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0234_));
 sky130_fd_sc_hd__a22o_1 _0899_ (.A1(net90),
    .A2(net111),
    .B1(net135),
    .B2(net133),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _0901_ (.A1(\product_reg[1] ),
    ...
    .VPWR(VPWR),
    .X(_0044_));
 sky130_fd_sc_hd__and4_1 _0902_ (.A(net90),
    .B(net133),
    .C(net109),
    .D(net112),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0237_));
 sky130_fd_sc_hd__a22oi_1 _0903_ (.A1(net90),
    .A2(net109),
    .B1(net112),
    .B2(net133),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0238_));
 sky130_fd_sc_hd__a22o_1 _0904_ (.A1(net90),
    .A2(net109),
    .B1(net112),
    .B2(net133),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _0969_ (.A1(net131),
    ...
    .VPWR(VPWR),
    .X(_0301_));
 sky130_fd_sc_hd__and4_2 _0970_ (.A(net88),
    .B(net131),
    .C(net104),
    .D(net101),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_2 _0994_ (.A1(_0299_),
    ...
    .VPWR(VPWR),
    .X(_0325_));
 sky130_fd_sc_hd__nand2_1 _0995_ (.A(net129),
    .B(net103),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22oi_4 _0996_ (.A1(net88),
    ...
    .VPWR(VPWR),
    .Y(_0327_));
 sky130_fd_sc_hd__a22o_1 _0997_ (.A1(net88),
    .A2(net98),
    .B1(net101),
    .B2(net131),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _0998_ (.A(net134),
    ...
    .VPWR(VPWR),
    .Y(_0329_));
 sky130_fd_sc_hd__and4_1 _0999_ (.A(net88),
    .B(net131),
    .C(net98),
    .D(net101),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _1003_ (.A1(net129),
    ...
    .VPWR(VPWR),
    .X(_0334_));
 sky130_fd_sc_hd__a41o_1 _1004_ (.A1(net88),
    .A2(net131),
    .A3(net98),
    .A4(net6),
    .B1(_0326_),
 ...
 sky130_fd_sc_hd__inv_2 _1057_ (.A(_0386_),
    ...
    .VPWR(VPWR),
    .Y(_0387_));
 sky130_fd_sc_hd__o2bb2a_1 _1058_ (.A1_N(_0385_),
    .A2_N(_0386_),
    .B1(_0075_),
    .B2(net87),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1064_ (.A1(_0326_),
    ...
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__nand2_2 _1065_ (.A(net130),
    .B(net100),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22oi_4 _1066_ (.A1(net134),
    ...
    .VPWR(VPWR),
    .Y(_0396_));
 sky130_fd_sc_hd__a22o_2 _1067_ (.A1(net134),
    .A2(net95),
    .B1(net92),
    .B2(net91),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0397_));
 sky130_fd_sc_hd__and4_1 _1068_ (.A(net91),
    .B(net134),
    .C(net96),
    .D(net92),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__nand4_4 _1069_ (.A(net91),
    .B(net134),
    .C(net96),
    .D(net92),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o22ai_4 _1072_ (.A1(_0074_),
    ...
    .VPWR(VPWR),
    .Y(_0402_));
 sky130_fd_sc_hd__a41o_1 _1073_ (.A1(net91),
    .A2(net134),
    .A3(net96),
    .A4(net93),
    .B1(_0395_),
 ...
 sky130_fd_sc_hd__o21bai_1 _1086_ (.A1(_0409_),
    ...
    .VPWR(VPWR),
    .Y(_0416_));
 sky130_fd_sc_hd__o2bb2a_1 _1087_ (.A1_N(net108),
    .A2_N(net119),
    .B1(_0409_),
    .B2(_0411_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _1129_ (.A(_0452_),
    ...
    .VPWR(VPWR),
    .Y(_0458_));
 sky130_fd_sc_hd__a22oi_2 _1130_ (.A1(net130),
    .A2(net96),
    .B1(net93),
    .B2(net134),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0459_));
 sky130_fd_sc_hd__a22o_2 _1131_ (.A1(net130),
    .A2(net96),
    .B1(net93),
    .B2(net134),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0460_));
 sky130_fd_sc_hd__nand2_2 _1132_ (.A(net130),
    .B(net93),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand4_4 _1285_ (.A(net121),
    ...
    .VPWR(VPWR),
    .Y(_0611_));
 sky130_fd_sc_hd__a22o_1 _1286_ (.A1(net97),
    .A2(net120),
    .B1(net94),
    .B2(net122),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1306_ (.A(_0607_),
    ...
    .VPWR(VPWR),
    .Y(_0631_));
 sky130_fd_sc_hd__and2_1 _1307_ (.A(net97),
    .B(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0632_));
 sky130_fd_sc_hd__nand2_1 _1308_ (.A(net97),
    .B(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31a_1 _1356_ (.A1(_0080_),
    ...
    .VPWR(VPWR),
    .X(_0679_));
 sky130_fd_sc_hd__a2111oi_1 _1357_ (.A1(net97),
    .A2(net116),
    .B1(_0080_),
    .C1(net87),
    .D1(_0677_),
 ...
 sky130_fd_sc_hd__a31oi_1 _1365_ (.A1(_0678_),
    ...
    .VPWR(VPWR),
    .Y(_0058_));
 sky130_fd_sc_hd__and2_1 _1366_ (.A(net90),
    .B(net85),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 input10 (.A(b_in[1]),
    ...
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__dlymetal6s2s_1 input11 (.A(b_in[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout90 (.A(net91),
    ...
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__buf_2 fanout91 (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout93 (.A(net94),
    ...
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__buf_2 fanout94 (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout100 (.A(net101),
    ...
    .VPWR(VPWR),
    .X(net100));
 sky130_fd_sc_hd__buf_4 fanout101 (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout129 (.A(net130),
    ...
    .VPWR(VPWR),
    .X(net129));
 sky130_fd_sc_hd__clkbuf_4 fanout130 (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
