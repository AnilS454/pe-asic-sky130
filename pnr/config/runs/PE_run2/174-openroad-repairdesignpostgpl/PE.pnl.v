module PE (clear_acc,
 ...
 sky130_fd_sc_hd__nor2_1 _0892_ (.A(_0077_),
    ...
    .VPWR(VPWR),
    .Y(_0040_));
 sky130_fd_sc_hd__and2_1 _0893_ (.A(net96),
    .B(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _0969_ (.A1(net127),
    ...
    .VPWR(VPWR),
    .X(_0301_));
 sky130_fd_sc_hd__and4_2 _0970_ (.A(net87),
    .B(net127),
    .C(net101),
    .D(net99),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_2 _0994_ (.A1(_0299_),
    ...
    .VPWR(VPWR),
    .X(_0325_));
 sky130_fd_sc_hd__nand2_1 _0995_ (.A(net125),
    .B(net101),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _1065_ (.A(net126),
    ...
    .VPWR(VPWR),
    .Y(_0395_));
 sky130_fd_sc_hd__a22oi_4 _1066_ (.A1(net129),
    .A2(net93),
    .B1(net90),
    .B2(net89),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0396_));
 sky130_fd_sc_hd__a22o_2 _1067_ (.A1(net129),
    .A2(net93),
    .B1(net90),
    .B2(net89),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0397_));
 sky130_fd_sc_hd__and4_1 _1068_ (.A(net89),
    .B(net129),
    .C(net93),
    .D(net90),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__nand4_4 _1069_ (.A(net89),
    .B(net129),
    .C(net93),
    .D(net90),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1109_ (.A(_0438_),
    ...
    .VPWR(VPWR),
    .Y(_0439_));
 sky130_fd_sc_hd__o2bb2ai_1 _1110_ (.A1_N(_0437_),
    .A2_N(_0438_),
    .B1(_0362_),
    .B2(_0365_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22oi_2 _1130_ (.A1(net126),
    ...
    .VPWR(VPWR),
    .Y(_0459_));
 sky130_fd_sc_hd__a22o_2 _1131_ (.A1(net126),
    .A2(net93),
    .B1(net90),
    .B2(net129),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o221ai_4 _1180_ (.A1(_0439_),
    ...
    .VPWR(VPWR),
    .Y(_0509_));
 sky130_fd_sc_hd__o211ai_1 _1181_ (.A1(_0435_),
    .A2(_0381_),
    .B1(_0508_),
    .C1(_0507_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand4_4 _1285_ (.A(net120),
    ...
    .VPWR(VPWR),
    .Y(_0611_));
 sky130_fd_sc_hd__a22o_1 _1286_ (.A1(net96),
    .A2(net117),
    .B1(net92),
    .B2(net120),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1306_ (.A(_0607_),
    ...
    .VPWR(VPWR),
    .Y(_0631_));
 sky130_fd_sc_hd__and2_1 _1307_ (.A(net96),
    .B(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0632_));
 sky130_fd_sc_hd__nand2_1 _1308_ (.A(net96),
    .B(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31a_1 _1356_ (.A1(_0080_),
    ...
    .VPWR(VPWR),
    .X(_0679_));
 sky130_fd_sc_hd__a2111oi_1 _1357_ (.A1(net96),
    .A2(net114),
    .B1(_0080_),
    .C1(_0081_),
    .D1(_0677_),
 ...
 sky130_fd_sc_hd__buf_2 fanout91 (.A(net92),
    ...
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__clkbuf_2 fanout92 (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
