module PE (clear_acc,
 ...
 sky130_fd_sc_hd__nor2_1 _0887_ (.A(_0075_),
    ...
    .VPWR(VPWR),
    .Y(_0035_));
 sky130_fd_sc_hd__and2_1 _0888_ (.A(net109),
    .B(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0036_));
 sky130_fd_sc_hd__and2_1 _0889_ (.A(net106),
    .B(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_4 _0895_ (.A1(net20),
    ...
    .VPWR(VPWR),
    .Y(_0232_));
 sky130_fd_sc_hd__and3_1 _0896_ (.A(net89),
    .B(net131),
    .C(net81),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o22a_1 _0897_ (.A1(\product_reg[0] ),
    ...
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__nand4_1 _0898_ (.A(net89),
    .B(net129),
    .C(net109),
    .D(net131),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0234_));
 sky130_fd_sc_hd__a22o_1 _0899_ (.A1(net89),
    .A2(net109),
    .B1(net131),
    .B2(net129),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand4_2 _0913_ (.A(net103),
    ...
    .VPWR(VPWR),
    .Y(_0247_));
 sky130_fd_sc_hd__a22oi_1 _0914_ (.A1(net103),
    .A2(net88),
    .B1(net128),
    .B2(net106),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a311o_1 _0922_ (.A1(_0250_),
    ...
    .VPWR(VPWR),
    .X(_0256_));
 sky130_fd_sc_hd__a22o_1 _0923_ (.A1(net132),
    .A2(net123),
    .B1(_0254_),
    .B2(_0255_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _0931_ (.A(net106),
    ...
    .VPWR(VPWR),
    .Y(_0264_));
 sky130_fd_sc_hd__a22oi_4 _0932_ (.A1(net103),
    .A2(net128),
    .B1(net102),
    .B2(net88),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0265_));
 sky130_fd_sc_hd__a22o_2 _0933_ (.A1(net103),
    .A2(net128),
    .B1(net102),
    .B2(net88),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_2 _0994_ (.A1(_0299_),
    ...
    .VPWR(VPWR),
    .X(_0325_));
 sky130_fd_sc_hd__nand2_1 _0995_ (.A(net126),
    .B(net102),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_2 _1067_ (.A1(net130),
    ...
    .VPWR(VPWR),
    .X(_0397_));
 sky130_fd_sc_hd__and4_2 _1068_ (.A(net90),
    .B(net130),
    .C(net94),
    .D(net91),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__nand4_4 _1069_ (.A(net90),
    .B(net130),
    .C(net94),
    .D(net91),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _1368_ (.A(_0074_),
    ...
    .VPWR(VPWR),
    .Y(_0061_));
 sky130_fd_sc_hd__and2_1 _1369_ (.A(net123),
    .B(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0062_));
 sky130_fd_sc_hd__and2_1 _1370_ (.A(net119),
    .B(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout92 (.A(net93),
    ...
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__clkbuf_2 fanout93 (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout96 (.A(net97),
    ...
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__clkbuf_4 fanout97 (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
